...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2024 at 10:10 AM
...
(3, 0.0000, 'Đã thanh toán', 'Chuyển Khoản ngân hàng', '2024-11-05 11:05:16', '2024-11-05 06:44:20', 1, 1),
(4, 0.0000, 'Đã thanh toán', 'Tiền Mặt', '2024-11-05 09:57:09', '2024-11-05 06:52:35', 1, 1),
...
(12, 250000.0000, 'Chờ xác nhận', 'Chuyển Khoản ngân hàng', '2024-12-08 06:56:55', '2024-12-08 06:56:39', 1, 1),
...
--
ALTER TABLE `danhgia`
  MODIFY `ID_DanhGia` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `goitap`
--
ALTER TABLE `goitap`
  MODIFY `IDGoiTap` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
