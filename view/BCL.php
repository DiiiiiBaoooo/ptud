        ...
        <div class="right">
            ...
            <div class="update-info-container">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    $tbl = $o->getAllTB();
                    if ($tbl) {
                        echo ' <select name="nametbloi" style="width:calc(100%)" class="form-select" aria-label="Default select example">';
                    ...
                    <select name="kq" style="width:calc(100%)" class="form-select" aria-label="Default select example">
                    ...
                    <label for="cp">Chi Phí Bảo Trì</label>
