    ...
    <div class="container pt-5">
        ...
        <div class="right">
            <div class="update-info-container">
                ...
                <span class="Ten">' . $r['TenNhanVien'] . '</span>
                <br>
                ...
                <label for="thanhvien">Ngày vào làm:</label>
                <span class="thanhvien">' . $r['NgayVaoLam'] . '</span>
                <br>
                ...
                <div class="button-group">
                    ...
                    <button type="submit" onclick="window.location.href='CapNhatTTCNNV.php'" class="update-btn">Cập nhật
                        TTTT</button>
