    ...
    <div class="container pt-5">
        ...
        <div class="right">
            <div class="update-info-container">
                <div style="background:white; padding:20px; width:600px; text-align:center; border-radius:10px;">

                    <h3>Chuyển Khoản Ngân Hàng</h3>
                    <p>Scan mã QR để thanh toán:</p>
                    <img src="login/images/ThanhToans.jpg" alt="QR Code" style="width:200px; height:200px;">
                    <p>Hoặc chuyển khoản đến tài khoản ngân hàng:</p>
