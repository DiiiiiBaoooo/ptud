        ...
        <div class="right">
            <div class="confirmation">
                ...
                <form action="" method="POST">
                    <input type="hidden" name="idnv" value="<?php echo $_REQUEST['idnv']; ?>">
                    <input type="submit" value="Xóa" name="delete" class="delete-btn">
                    <a href="./QLNV.php"><input type="button" value="Hủy" class="cancel-btn""></a>
                </form>
            </div>
            <?php

            if (isset($_POST['delete'])) {
                $iduser = $_POST['idnv']; // Nhận ID từ form
                include_once('../controller/cNhanVien.php');

                $p = new cNhanVien();
                $kq = $p->cXoaNV($iduser); // Gọi hàm xóa
    ...
    <div class=" footer container-fluid mt-3 py-5 px-sm-3 px-md-5 text-white">
                        <div class="row pt-5">
                            <div class="col-lg-3 col-md-6 mb-5">
                                ...
                                <p><i class="fa fa-map-marker-alt mr-2"></i>4 Nguyễn Văn Bảo, Gò Vấp, Thành phố Hồ Chí
                                    Minh</p>
                                ...
                                <div class="d-flex justify-content-start mt-4">
                                    ...
                                    <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0"
                                        style="width: 40px; height: 40px;" href="#"><i
                            ...
                            <div class="col-lg-3 col-md-6 mb-5">
                                ...
                                <div class="d-flex flex-column justify-content-start">
                                    ...
                                    <a class="text-white mb-2" href="./class.php"><i
                                            class="fa fa-angle-right mr-2"></i>Lớp học</a>
