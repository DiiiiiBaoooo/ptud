    ...
    <div class="container pt-5">
        ...
        <div class="right">
            <div class="update-info-container">
                ...
                $p = new cThietBi();
                if (isset($_REQUEST['idtbl'])) {
                    $idtbl = $_REQUEST['idtbl'];
                    $kq = $p->select1tbl($idtbl);
                    if ($kq) {
                ...
                <label for="phone">Thông tin lỗi:</label>
                <span class="sdt">' . $r['ThongTinLoi'] . '</span>
                <br>
                <label for="Email">Ngày xảy ra lỗi:</label>
                <span class="email">' . date("d/m/Y", strtotime(explode(' ', $r['NgayXayRaLoi'])[0]))  . '</span>
                <br>
                <label for="address">Kết quả bảo trì:</label>
                <span class="diachi">' . $r['KetQuaBaoTri'] . '</span>
