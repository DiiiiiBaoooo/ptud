...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <div class="d-inline-flex">
                ...
                <p class="m-0 text-white">Quản lý đánh giá</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container pt-5">
        ...
        <div class="right">
            <div class="qltv">
                <h1 align="center" style="font-size: 35px!important;">Quản lý Đánh giá</h1>
                ...
                <div class="review-list" style="margin-top: 20px;">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="reviewTableBody">
                            <?php
                            $sql = "SELECT danhgia.ID_DanhGia, thanhvien.TenThanhVien, danhgia.NoiDung 
                                    FROM danhgia 
                                    JOIN thanhvien ON danhgia.ID_ThanhVien = thanhvien.IDThanhVien";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td>" . $stt . "</td>";
                                    echo "<td>" . $row['TenThanhVien'] . "</td>";
                                    echo "<td>" . $row['NoiDung'] . "</td>";
                                    echo "<td><button class='delete-btn' data-id='" . $row['ID_DanhGia'] . "'>Xóa</button></td>";
                                    echo "</tr>";
                                    $stt++;
                                }
                            } else {
                ...
                <div id="editReviewForm" class="create-review-form" style="display: none; margin-top: 20px;">
                    <h3>Sửa Đánh Giá</h3>
                    <form method="POST" action="edit_danhgia.php" id="editForm">
                        <input type="hidden" id="editReviewId" name="id">
                        <div class="form-group">
                            <label for="editReviewerName">Tên Người Đánh Giá</label>
                            <input type="text" id="editReviewerName" name="TenNguoiDanhGia" class="form-control"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="editReviewContent">Nội Dung Đánh Giá</label>
                            <textarea id="editReviewContent" name="NoiDung" class="form-control" required></textarea>
                        </div>
