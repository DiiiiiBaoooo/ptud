...
<body class="bg-white">
    ...
    <div class="container pt-5">
        ...
        <div class="right">
            ...
            $p = new cGoiTap();
            if (isset($_REQUEST['btnadd']) && $_REQUEST['btnadd'] == "Tạo") {
                $insertGT = $p->addGoiTap($_REQUEST['TenGoi'], $_REQUEST['Gia'], $_REQUEST['thoihan']);
                if ($insertGT) {
                    echo "<script>alert('thêm  thông tin gói tập thành công');</script>";
                    echo "<script>window.location.href = 'QLGT.php';</script>";
                } else {
                    echo "<script>alert('thêm  thông tin gói tập không thành công');</script>";
                    echo "<script>window.location.href = 'QLGT.php';</script>";
                }
            }
